...
function Signup() {
    ...
    const handleSubmit = async(e) => {
      ...
      e.preventDefault();
      const userData = {name:username,password:pass,email:email,image:"https://say-data-assignment.vercel.app/static/media/icon.fe59d9d7df33d043cf5a.jpg",bio:"Add Bio",occupation:"Student"};
