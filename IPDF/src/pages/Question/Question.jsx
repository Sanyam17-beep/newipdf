      ...
      <div className="Home">
        <div className="Questions-container">
          <div className="Post">
            ...
            <div className="Post-question">{question?.title}</div>
            {question?.postImg !== null && (
              <div className="colorBox1">
                <img className="poimage " src={question?.postImg} />
              </div>
            )}
            {question?.answer != "" && (
            ...
            <div className="upvote-downvote">
              <div className="Vote-reply-container">
                ...
                <div className="reply">Reply: {question?.replies?.length}</div>
              </div>
              <div className="moment-post">
                {moment(new Date(question?.createdAt)).fromNow()}
              </div>
            </div>
          </div>
          {userJs.occupation == "Teacher" && (
