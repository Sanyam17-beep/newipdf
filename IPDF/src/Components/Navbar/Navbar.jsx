        ...
        <div className='Navbar'>
            ...
            <div className='Profile-container'>
                <div className="Nav-Corner">
                   ...
                   {props.logout!="logout"&&<div className="ProfileIcon" style={{ cursor: "pointer" }} onClick={()=>{navigate(`/profile/${tempuser.id}`)}}><img src={tempuser.img} alt="icon" className='image' /></div>
                   } 
                   {
